...
filename = strftime("%G%m%d")
print(filename)

file = open("/home/pi/Desktop/software/static/logs/%s.csv" %filename, "a")
if os.stat("/home/pi/Desktop/software/static/logs/%s.csv" %filename).st_size == 0:
...
while True:
    ...
    file = open("/home/pi/Desktop/software/static/logs/currentdata.csv", "w")
    file.write(strftime("%G,%m,%d,%H,%M,%S")+"," + str(ntc0temp)+"," + str(ntc1temp)+"," + str(ntc2temp)+"," + str(ntc3temp)+"," + str(cputemp)+"\n")
    file.flush()
    file.close()
